...
var Feeds = class {
  ...
  async syncOneFeed(feed, vault) {
    ...
    content.items.forEach((item) => {
      ...
      vault.create(path + "/" + sanitizedTitle + ".md", text).then((file) => {
  ...
  parseItem(template, item, feed) {
    ...
    return template.replaceAll("{{feed.feedUrl}}", (_a = feed.feedUrl) != null ? _a : "").replaceAll("{{feed.title}}", (_b = feed.title) != null ? _b : "").replaceAll("{{feed.description}}", (_c = feed.description) != null ? _c : "").replaceAll("{{feed.link}}", (_d = feed.link) != null ? _d : "").replaceAll("{{item.title}}", (_e = item.title) != null ? _e : "").replaceAll("{{item.description}}", (_f = item.description) != null ? _f : "").replaceAll("{{item.author}}", (_g = item.author) != null ? _g : "").replaceAll("{{item.link}}", (_h = item.link) != null ? _h : "").replaceAll("{{item.guid}}", (_i = item.guid) != null ? _i : "").replaceAll("{{item.comments}}", (_j = item.comments) != null ? _j : "").replaceAll("{{item.categories}}", categories).replaceAll("{{item.pubDate}}", (_k = item.pubDate) != null ? _k : "");
  }
};
