...
class UnicodePDF(FPDF):
    ...
    def __init__(self):
        ...
        # Swap width and height because we're using orientation='P'
    ...
    try:
        ...
        for line in lines:
            ...
            if image_batch:
                ...
                add_image_grid(pdf, image_batch, image_width, image_height, caption_height, max_per_row, rows_per_page, spacing, margin)
...
def add_image_grid(pdf, image_paths, image_width, image_height, caption_height, max_per_row, max_rows, spacing, margin):
...
def main():
    ...
    print("=== Org to PDF (16x9 inches Landscape, 4x2 Image Grid, aspect ratio kept) ===")
