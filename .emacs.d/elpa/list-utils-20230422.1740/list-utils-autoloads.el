;;; list-utils-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(let ((loads (get 'list-utils 'custom-loads))) (if (member '"list-utils" loads) nil (put 'list-utils 'custom-loads (cons '"list-utils" loads)) (put 'extensions 'custom-loads (cons 'list-utils (get 'extensions 'custom-loads)))))
(require 'cl-macs)
...
(fn LIST &optional TREE RECUR-INTERNAL)")
...
(fn LIST-1 LIST-2 &optional TEST)")
...
(fn LIST ELEMENT NEW-ELEMENT &optional TEST)")
...
(fn LIST1 LIST2 &optional TEST HINT FLIP)")
