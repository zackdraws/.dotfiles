...
ITALIC? and BOLD? control font variant."
			  (let ((font-variants `(,@(when italic? `(:italic t))
									 ...
									 ,@(when bold? `(:bold t)))))
          `((t ,(pcase var
                  ('background `(:background ,(or bg stimmung-themes-light-highlight-color)
                                 :foreground ,fg1
                                 ,@font-variants))
                  ('foreground `(:foreground ,(or fg stimmung-themes-light-highlight-color-foreground)
                                 ,@font-variants))
                  ('none `(:foreground ,fg1
                           ,@font-variants))))))))
   ...
   `(font-lock-property-use-face      ((t (:foreground ,fg1 :italic t))))
	 ...
	 `(treemacs-fringe-indicator-face         ((t (:background ,bg4     :foreground ,bg4))))
