;;; stimmung-themes-dark-theme.el --- A dark theme tuned to inner harmonies -*- lexical-binding: t -*-
;; Copyright © 2019
...
ITALIC? and BOLD? control font variant."
			  (let ((font-variants `(,@(when italic? `(:italic t))
				...
				`((t ,(pcase var
						...
						('foreground `(:background ,bg1 :foreground ,(or fg stimmung-themes-dark-highlight-color-foreground) ,@font-variants))
	...
	(custom-theme-set-faces
	 ...
	 `(vertical-border     ((t (:foreground ,bg3 :background ,bg3))))
	 ...
	 ;; avy
	 `(avy-lead-face   ((t (:background ,bg3 :foreground ,fg1 :distant-foreground ,fg1 :bold t))))
	 ...
	 `(company-tooltip-scrollbar-track        ((t (:background ,bg3))))
	 `(company-tooltip-common                 ((t (:foreground ,fg1))))
	 `(company-tooltip                        ((t (:background ,bg3 :foreground ,fg1 :inherit fixed-pitch))))
	 ...
	 `(consult-separator          ((t (:background ,bg1 :foreground ,fg5))))
	 ...
	 `(mode-line-inactive  ((t (:foreground ,fg5 :background ,bg3 :box nil))))
	 ...
	 `(centaur-tabs-unselected          ((t (:foreground ,fg5 :background ,bg3))))
	 `(centaur-tabs-selected            ((t (:foreground ,fg1 :background ,bg1))))
	 `(centaur-tabs-unselected-modified ((t (:foreground ,fg5 :background ,bg3))))
	 `(centaur-tabs-selected-modified   ((t (:foreground ,fg1 :background ,bg1))))
	 `(centaur-tabs-close-unselected    ((t (:foreground ,fg3 :background ,bg3))))
	 ...
	 `(centaur-tabs-active-bar-face     ((t (:background ,stimmung-themes-dark-highlight-color))))
	 ...
	 `(ivy-separator                  ((t (:foreground ,stimmung-themes-dark-highlight-color))))
	 ...
	 `(helm-lisp-show-completion		((t (:background ,bg3))))
	 ...
	 `(magit-process-ng             ((t (:background ,stimmung-themes-dark-highlight-color :bold t))))
	 ...
	 `(markdown-inline-code-face        ((t (:foreground ,fg1 :background ,stimmung-themes-dark-highlight-color :inherit fixed-pitch))))
	 ...
	 ;; solaire
	 `(solaire-default-face            ((t (:background ,bg3 :foreground ,fg1))))
	 `(solaire-fringe-face             ((t (:background ,bg3 :foreground ,fg1))))
	 `(solaire-line-number-face        ((t (:background ,bg3 :foreground ,fg5))))
	 `(solaire-hl-line-face            ((t (:background ,bg2 :extend t))))
	 `(solaire-org-hide-face           ((t (:background ,bg3 :foreground ,fg1))))
	 `(solaire-mode-line-face          ((t (:background ,bg3 :foreground ,fg1 :box nil))))
	 `(solaire-mode-line-inactive-face ((t (:background ,bg3 :foreground ,fg4 :box nil))))
	 `(solaire-header-line-face        ((t (:background ,bg3 :foreground ,fg1 :bold t))))
	 ...
	 `(font-latex-sedate-face       ((t (:foreground ,fg1 :background ,bg1))))
	 `(font-latex-italic-face       ((t (:foreground ,fg1 :italic t))))
	 `(font-latex-bold-face         ((t (:foreground ,fg1 :bold t))))
	 `(font-latex-verbatim-face     ((t (:background ,stimmung-themes-dark-highlight-color :bold t))))
	 ...
	 `(lsp-ui-sideline-current-symbol	((t (:foreground ,fg1 :background ,stimmung-themes-dark-highlight-color))))
     ...
     ;; lsp-bridge
	 `(lsp-bridge-ref-font-lock-header-line-text      ((t (:foreground ,fg1))))
	 `(lsp-bridge-ref-font-lock-header-line-edit-mode ((t (:foreground ,fg1))))
	 `(lsp-bridge-ref-font-lock-command               ((t (:foreground ,fg1 :bold t))))
	 `(lsp-bridge-ref-font-lock-file                  ((t (:foreground ,fg1 :bold t))))
	 `(lsp-bridge-ref-font-lock-line-number           ((t (:inherit 'line-number))))
	 `(lsp-bridge-ref-font-lock-column-number         ((t (:inherit 'line-number))))
	 `(lsp-bridge-ref-font-lock-position-splitter     ((t (:foreground ,fg1))))
	 `(lsp-bridge-ref-font-lock-match                 ((t (:foreground ,fg1 :background ,search2))))
	 `(lsp-bridge-ref-font-lock-diagnostic            ((t (:inherit 'error :background ,bg3))))
	 `(lsp-bridge-ref-font-lock-mark-changed          ((t (:foreground ,fg1 :background ,search2 :italic t))))
	 `(lsp-bridge-ref-font-lock-mark-deleted          ((t (:foreground ,fg1 :strike-through ,red))))
	 `(lsp-bridge-ref-font-lock-function-location     ((t (:foreground ,fg1 :background ,search2))))

   ;; ACM
   `(acm-frame-default-face ((t (:background ,bg3 :foreground ,fg1))))
   `(acm-frame-border-face  ((t (:background ,bg2 :foreground ,fg1))))
	 ...
	 `(tree-sitter-hl-face:constructor           ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:doc                   ((t (:inherit 'font-lock-comment-face))))
	 `(tree-sitter-hl-face:embedded              ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:escape                ((t (:foreground ,fg1))))
	 ...
	 `(tree-sitter-hl-face:function.call         ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:function.macro        ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:function.special      ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:keyword               ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:label                 ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:method                ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:method.call           ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:number                ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:operator              ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:property              ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:property.definition   ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:punctuation           ((t (:foreground ,fg5))))
	 `(tree-sitter-hl-face:punctuation.bracket   ((t (:foreground ,fg5))))
	 `(tree-sitter-hl-face:punctuation.special   ((t (:foreground ,fg5))))
	 `(tree-sitter-hl-face:punctuation.delimiter ((t (:foreground ,fg5))))
	 ...
	 `(tree-sitter-hl-face:tag                   ((t (:foreground ,fg1 :bold t))))
	 `(tree-sitter-hl-face:type                  ((t (:inherit font-lock-type-face))))
	 `(tree-sitter-hl-face:type.argument         ((t (:foreground ,fg1 :italic t))))
	 `(tree-sitter-hl-face:type.builtin          ((t (:foreground ,fg1 :italic t))))
	 `(tree-sitter-hl-face:type.parameter        ((t (:foreground ,fg1 :italic t))))
	 `(tree-sitter-hl-face:type.super            ((t (:foreground ,fg1 :italic t))))
	 `(tree-sitter-hl-face:type.variable         ((t (:foreground ,fg1 :italic t))))
	 `(tree-sitter-hl-face:variable.builtin      ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:variable.parameter    ((t (:foreground ,fg1))))
	 `(tree-sitter-hl-face:variable.special      ((t (:foreground ,fg1))))
...
(provide-theme 'stimmung-themes-dark)
(provide 'stimmung-themes-dark-theme)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; stimmung-themes-dark-theme.el ends here
