;;; sage-shell-mode-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Move to end of block sent." t)
(autoload 'sage-shell-blocks:pull-next "sage-shell-blocks" "\
Evaluate the next block of the last visited file in Sage mode." t)
...
(fn FILENAME)" t)
(autoload 'sage-shell-sagetex:load-current-file "sage-shell-mode" nil t)
...
(fn F)" t)
(autoload 'sage-shell-sagetex:compile-current-file "sage-shell-mode" nil t)
...
(fn F)" t)
(autoload 'sage-shell-sagetex:run-latex-and-load-current-file "sage-shell-mode" nil t)
...
Only use this when sage is running." t)
...
(provide 'sage-shell-mode-autoloads)
