...
(defvar base16-windows-highcontrast-light-theme-colors
  '(:base00 "#fcfcfc"
    :base01 "#e8e8e8"
    :base02 "#d4d4d4"
    :base03 "#c0c0c0"
...
(base16-theme-define 'base16-windows-highcontrast-light base16-windows-highcontrast-light-theme-colors)
