;;; ucs-utils-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(let ((loads (get 'ucs-utils 'custom-loads))) (if (member '"ucs-utils" loads) nil (put 'ucs-utils 'custom-loads (cons '"ucs-utils" loads)) (put 'i18n 'custom-loads (cons 'ucs-utils (get 'i18n 'custom-loads)))))
...
(fn &optional PROGRESS REGENERATE)")
...
(fn NAME &optional FALLBACK TEST)")
...
(fn SEQUENCE &optional FALLBACK TEST NO-FLATTEN)")
...
(fn SEQUENCE &optional FALLBACK TEST)")
...
(fn SEQUENCE FALLBACK &optional TEST)")
...
(fn START END FROM-CHAR TO-CHAR &optional NO-UNDO)")
...
(fn CHARACTER &optional COUNT INHERIT)" t)
