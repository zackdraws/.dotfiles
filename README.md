...
configuration files for emacs are stored on your computer locally in `~/.emacs.d/init.el`
...
- 1 to 9 - Switch directly to the N-th tab (e.g., 1 for the first tab, 2 for the second)
...
Photoshop is what I use for most painting.
...
For editing reels and animation scenes.

## Blender

For editing reels and animation scenes, it's similar to Premiere, most things can be done in Blender but they just require a bit more research and time.
...
use for editing, converting and trimming videos
...
** to export to convert to mp4 file

```
ffmpeg -i input.avi -r 24 output.mp4
```

## - play files from the terminal in a folder

either by mpv [file name] or if you aren't certain of the file name
