...
for file in glob.glob('*.jpg') + glob.glob('*.jpeg'):
    ...
    kernel_dilate = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (45, 45))  # big for ultra soft glow
    ...
    # Light yellow: approx RGB(255, 255, 204) → BGR(204, 255, 255)
...
echo "✅ Ultra soft light yellow matte applied to all jpg/jpeg images in folder."
